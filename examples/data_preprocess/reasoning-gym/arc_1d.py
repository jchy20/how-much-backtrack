...
User: {question}\nShow your work in <think> </think> tags, and return it in <answer> </answer> tags with space between each number. For example <answer> 1 3 5 7 </answer>.
Assistant: Let me solve this step by step.
<think>"""

    elif template_type == 'qwen-instruct':
        """This works for Qwen Instruct Models"""
        prefix = f"""<|im_start|>system\nYou are a helpful assistant. You first thinks about the reasoning process in the mind and then provides the user with the answer.<|im_end|>\n<|im_start|>user\n{question}\nShow your work in <think> </think> tags, and return it in <answer> </answer> tags with space between each number. For example <answer> 1 3 5 7 </answer>.<|im_end|>\n<|im_start|>assistant\nLet me solve this step by step.\n<think>"""
    return prefix   
