...
#SBATCH --job-name=qwen3b-inst_from_sudoku_synthetic_three_backtrack
#SBATCH --output=slurm_logs/qwen3b-inst_from_sudoku_synthetic_three_backtrack.out
...
export TRAIN_DATA_DIR=/home/users/hc387/data/sudoku/sft_backtrack/qwen-instruct_three_backtrack.parquet
...
export EXPERIMENT_NAME=qwen3b-inst_from_sudoku_synthetic_three_backtrack
